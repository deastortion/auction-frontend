...
<!-- for a single auction card on the page. The data for this component is  -->
<!-- passed through by it's parent component (in this case I believe it was AuctionsView.vue) -->
<template>
    <div class="auction">
