            ...
            <div class="auctions__body">
                ...
                <section class="auctions__create">
                    <form class="form" autocomplete="off" @submit.prevent="submit">
                        ...
                        <div class="form__group">
                            <label for="launchesAt" class="form__label">Launch date</label>
                            <input type="date" name="launchesAt" id="launchesAt" class="form__input" v-model="form.launchesAt"
                                required>
                        </div>
...
export default {
    ...
    methods: {
        submit() {
            this.$axios.post('/auctions', this.form).then((response) => {
